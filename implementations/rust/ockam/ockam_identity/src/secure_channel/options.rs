...
pub struct SecureChannelOptions {
    ...
    pub(crate) credential_retriever: Option<Arc<dyn CredentialsRetriever>>,
...
impl SecureChannelOptions {
    ...
    pub fn with_credential_retriever(
        mut self,
        credential_retriever: Arc<dyn CredentialsRetriever>,
    ) -> Result<Self> {
    ...
    pub fn with_credential(mut self, credential: CredentialAndPurposeKey) -> Result<Self> {
        ...
        self.credential_retriever = Some(Arc::new(CredentialsMemoryRetriever::new(credential)));
        Ok(self)
    }
